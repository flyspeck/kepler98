(* Mathematica Code that calls CPLEX to deal
	...
	and cfsqp
	It runs on top of sphere.m in the countdown directory.

*)

(* Call GenerateInequalities to generate the list.
...
GenerateInequalities:= Module[{j},  (* was once called cT *)
	setTau;
	CorrectionList={};FindCorrections[z0,z1];
...
SetTau:=
	...
	xmin=Array[2&,16]; xmin[[16]]=2. Sqrt[2];
	xmax=Array[2.51&,16]; 
