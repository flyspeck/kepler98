...
static void setqr(domain& x,domain& z)
	{
	  interval tx[6]={"4","4","4","4","4","4.74063529"}; //2.1773^2
	interval tz[6]={"6.33436854000504728617","6.33436854000504728617","6.33436854000504728617","4.74063529","4.74063529","6.33436854000504728617"};
	x = domain::lowerD(tx);
	z = domain::upperD(tz);
	}
