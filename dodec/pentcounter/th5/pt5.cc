...
//*****************************************************************
  ...
  // Want to show: 
  //
  //  y1 < 2.314, y2 < 2.174, y3<2.26, y5 < 2.699, y6 < 3.196
  //
  // -> vol > .350
  //
  /////////////////////////////////////////////////////////////////
...
void vol3()
{
  ...
  // 2.194^2=4.813636, 2.314^2=5.354596, 2.26^2=5.1076
  // 2.174^2=4.726276, 2.699^2=7.284601, 3.196^2=10.214416
...
void mu3()
{
  ...
  // 2.194^2=4.813636, 2.314^2=5.354596, 2.26^2=5.1076
  // 2.174^2=4.726276, 2.809^2=7.890481, 3.196^2=10.214416
