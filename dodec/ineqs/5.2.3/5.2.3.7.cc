...
static void setqr(domain& x,domain& z)
	{
	  interval tx[6]={"4","4","4","4","4","4"}; //2.1773^2
	interval tz[6]={"6.33436854000504728617","6.33436854000504728617","6.33436854000504728617","4.74063529","4.74063529","4.74063529"};
	x = domain::lowerD(tx);
	z = domain::upperD(tz);
	}
...
void proveTet1()
{
  ...
  taylorFunction F=taylorSimplex::voronoiVolume*"-1"
                  ...
                  +taylorSimplex::dih*"0.0368"  
                  +taylorSimplex::dih2*"0.0368"  
                  +taylorSimplex::dih3*"0.0368"  
                  +taylorSimplex::unit*"-0.13591";
  ...
  if(prove::recursiveVerifier(0,x,z,x0,z0,K,5,opt)) 
    cout<<"5.4.5 Part 1 complete!"<<endl;
  else
    cout<<"5.4.5 Part 1 failed!!"<<endl;
