...
void proveTet1()
{
  ...
  interval tz[6]={"4.2025","5.1076",
		  "4.41","6.33436854000504728617",
		  "5.2441","6.33436854000504728617"};
  ...
  taylorFunction F=taylorSimplex::voronoiVolume*"-1"+
                   ...
                   taylorSimplex::y2*"0.026877"+
                   taylorSimplex::y3*"-0.068297"+ 
                   taylorSimplex::y5*"-0.015104"+
                   taylorSimplex::y6*"0.015104"+
                   taylorSimplex::dih*"-0.054196"+
                   taylorSimplex::unit*"0.145987"; 
...
void proveTet2()
{
  ...
  taylorFunction F=taylorSimplex::voronoiVolume*"-1"+
                   taylorSimplex::sol*"0.42755"+
                   taylorSimplex::y2*"0.068297"+
                   taylorSimplex::y3*"-0.068297"+ 
                   taylorSimplex::y5*"-0.015104"+
                   taylorSimplex::y6*"0.015104"+
                   taylorSimplex::dih*"-0.054196"+
                   taylorSimplex::unit*"0.064666";
...
void proveTet4()
{
  ...
  interval tz[6]={"4.4025","4.41",
		  "5.1076","6.33436854000504728617",
		  "6.33436854000504728617","5.2441"};
  ...
  taylorFunction F=taylorSimplex::voronoiVolume*"-1"+
                   taylorSimplex::sol*"0.42755"+
                   taylorSimplex::y2*"-0.068297"+
                   taylorSimplex::y3*"0.026877"+ 
                   taylorSimplex::y5*"0.015864"+
                   taylorSimplex::y6*"-0.015104"+
                   taylorSimplex::dih*"-0.054196"+
                   taylorSimplex::unit*"0.145987";
...
void proveTet5()
{
  ...
  interval tz[6]={"4.2025","5.1076",
		  "5.1076","10.24",
		  "6.33436854000504728617","6.33436854000504728617"};
  ...
  taylorFunction F=taylorSimplex::voronoiVolume*"0"+
                   taylorSimplex::sol*"0"+
                   taylorSimplex::y2*"-0.026877"+
                   taylorSimplex::y3*"-0.026877"+ 
                   taylorSimplex::y5*"-0.015864"+
                   taylorSimplex::y6*"-0.015864"+
                   taylorSimplex::dih*"-0.054196"+
                   taylorSimplex::unit*"0.268921";
