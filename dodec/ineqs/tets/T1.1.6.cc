...
void proveTet1()
{
  ...
  if(prove::recursiveVerifier(0,x,z,x0,z0,K,5,opt)) 
    cout<<"Part 1, TetMuLB complete!"<<endl;
  else
    cout<<"Part 1, TetMuLB failed!!"<<endl;
...
void proveTet2()
{
  ...
  if(prove::recursiveVerifier(0,x,z,x0,z0,K,2,opt))
    cout<<"Part 2, TetMuLB complete!"<<endl;
  else
    cout<<"Part 2, TetMuLB failed!!"<<endl;
}
...
void proveTet3()
{
  ...
  F.setReducibleState(1);
  if(prove::recursiveVerifier(0,x,z,x0,z0,K,2,opt))
    cout<<"Part 3, TetMuLB complete!"<<endl;
  else
    cout<<"Part 3, TetMuLB failed!!"<<endl;
}
...
void proveTet4()
{
  ...
  F.setReducibleState(1);
  if(prove::recursiveVerifier(0,x,z,x0,z0,K,2,opt))
    cout<<"Part 4, TetMuLB complete!"<<endl;
  else
    cout<<"Part 4, TetMuLB failed!!"<<endl;
}
...
void proveTet5()
{
  ...
  F.setReducibleState(1);
  if(prove::recursiveVerifier(0,x,z,x0,z0,K,2,opt))
    cout<<"Part 5, TetMuLB complete!"<<endl;
  else
    cout<<"Part 5, TetMuLB failed!!"<<endl;
}
