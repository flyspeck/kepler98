...
void standardQ()
	...
	cout << "running standardQ(QuadSolLB)= "<<endl;
	/*asymmetric*/{
	taylorFunction FA= taylorSimplex::sol*("-1")
		+taylorSimplex::unit*"0.731937";
		
	taylorFunction FB= taylorSimplex::sol*("-1");
