...
double dihedraly(double y1,double y2,double y3,double y4,
                        double y5, double y6);
double volume(double y1,double y2,double y3,double y4,double y5, double y6);
double truncVol(double y1,double y2,double y3,double y4,double y5, double y6);

double squander(double y1,double y2,double y3,double y4,double y5, double y6);
double squander2(double y1,double y2,double y3,double y4,double y5, double y6);

double VarSquander(double m, double a, double y1,double y2,double y3,double y4,                double y5, double y6);
double VarSquander2(double m, double a, double y1,double y2,double y3,double y4,                double y5, double y6);
...
double arc(double,double,double);
double psi2(double);
double beta(double, double,double);

const double T=1.25841;

const double A=0.0368;


const double M=0.42755;
#endif
