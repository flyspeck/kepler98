...
double volume(double y1,double y2,double y3,double y4,
	double y5,double y6)
	{
	double x1=y1*y1, x2=y2*y2, x3=y3*y3, 
		x4=y4*y4, x5=y5*y5, x6=y6*y6;
...
double squander(double y1,double y2,double y3,double y4,
	double y5,double y6)
        {
	  return volume(y1,y2,y3,y4,y5,y6) - M * solid(y1,y2,y3,y4,y5,y6);
	}

double squander2(double y1,double y2,double y3,double y4,
	double y5,double y6)
        {
	  return truncVol(y1,y2,y3,y4,y5,y6) - M * solid(y1,y2,y3,y4,y5,y6);
	}


double VarSquander(double m, double a, double y1,double y2,double y3,double y4,
	double y5,double y6)
         {
	   return volume(y1,y2,y3,y4,y5,y6) - m * solid(y1,y2,y3,y4,y5,y6)- a *              dihedraly(y1,y2,y3,y4,y5,y6);
	 }

double VarSquander2(double m, double a, double y1,double y2,double y3,double y4,
	double y5,double y6)
         {
	   return truncVol(y1,y2,y3,y4,y5,y6) - m * solid(y1,y2,y3,y4,y5,y6)- a *              dihedraly(y1,y2,y3,y4,y5,y6);
	 }
...
double truncVol(double y1,double y2,double y3,double y4,double y5,
		    double y6)
{
  return( 
   ( ( vorVc(y1,y2,y3,y4,y5,y6,1.25841)-(4.0/3.0)*solid(y1,y2,y3,y4,y5,y6) )
	    / (-4*doct) ));
   }

double truncQuadVol(double y1,double y2,double y3,double y4,double y5,
		    double y6,double y7,double y8,double y9)
{
  return( 
   ( ( ( vorVc(y1,y2,y3,y4,y5,y6,1.25841)-(4.0/3.0)*solid(y1,y2,y3,y4,y5,y6) )
	    / (-4*doct) )+
   ( ( vorVc(y7,y2,y3,y4,y8,y9,1.25841)-(4.0/3.0)*solid(y7,y2,y3,y4,y8,y9) )
	  /(-4*doct) ) )
	 );
}

double QuadSolid(double y1,double y2,double y3,double y4,double y5,
		    double y6,double y7,double y8,double y9)
{
  return(solid(y1,y2,y3,y4,y5,y6)+solid(y7,y2,y3,y4,y8,y9));
}



double QuadVarSquander(double sol, double dih, double y1,double y2,double y3,
       double y4,double y5,double y6,double y7,double y8,double y9)
{
  return (truncQuadVol(y1,y2,y3,y4,y5,y6,y7,y8,y9)-
	  sol*QuadSolid(y1,y2,y3,y4,y5,y6,y7,y8,y9)-
	  dih*dihedraly(y1,y2,y3,y4,y5,y6));

}

double QuadVarSquander2(double sol, double dih, double y1,double y2,double y3,
   double y4,double y5,double y6,double y7,double y8,double y9)
{
  return (truncQuadVol(y1,y2,y3,y4,y5,y6,y7,y8,y9)-
	  sol*QuadSolid(y1,y2,y3,y4,y5,y6,y7,y8,y9)-
	  dih*(dihedraly(y2,y1,y3,y5,y4,y6)+dihedraly(y2,y7,y3,y8,y4,y9)));
}
...
double arc(double a, double b, double c)
{
  return safeacos((a*a+b*b-c*c)/(2*a*b));
}

double psi2(double y1)
{
  return safeacos(y1/(2*T));
}


double beta(double y1,double y3,double y5)
{
  double a=psi2(y1); double b=arc(y1,y3,y5);
  double ppb=(cos(a)*cos(a)-cos(b)*cos(b))/(1-cos(b)*cos(b));
  double pb =safesqrt(ppb);
  return safeacos(pb);
}
