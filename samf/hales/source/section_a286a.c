...
void verifyocta( void )
{
	...
	printf("Welcome to Section A.2.8.6a.  \n");
...
/*
fred = 
List(-0.01003933081122432,-4.440892098500626e-16,
   -5.551115123125782e-16,2.442490654175344e-15,
   0.01003933081122543,1.110223024625156e-15,
   -5.551115123125782e-16,-2.109423746787797e-15,
   -0.01003933081122476,0.01003933081122543,
   0.06974651587012092,0.06974651587011604,
   0.06974651587011893,0.02880523638046206,
   0.002011623434119869,-0.002011623434119647,
   -0.06974651587012048,-0.06974651587011515,
   -0.06974651587011793,-0.02880523638046161,
   0.3720278575097912,0.4874189807593596,
   0.4874189807593422,0.5893802013611075,
   0.7363199215384168,0.3604781287594001)

room = 0.0472105182489341945
...
*/
	int i, j;
	double avars[4][5] = 
		{{-0.01003933081122432,0.,0.,0.,0.01003933081122432},
		{0.,0.,0.,-0.01003933081122432,0.01003933081122432},
		{0.06974651587012092,0.06974651587012092,
		0.06974651587012092,0.02880523638046206,
		0.002011623434119869},
		{-0.002011623434119869,
		-0.06974651587012092,-0.06974651587012092,
		-0.06974651587012092,-0.02880523638046206}};
	double cvals[5] = 
	...
	i_recognize( -0.056, avals );
	ROUND_DOWN;
	slop = origslop + avals[0];
...
void octa_score( double y[12], double x[12],
	double out[2], double out_partials[12] )
{
	double delta[2], sqrtdelta[2];
	
	i_bigdelta_best( x, delta );
	i_sqrt( delta, sqrtdelta );
	i_vor0( y, x, sqrtdelta, out );
	
	i_vor0_partials( y, x, out_partials );
}
