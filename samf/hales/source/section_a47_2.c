...
void verifyocta( void )
{
	...
	double diff, dt, three2[2], three23[2], origslop;
	time_t tstart, tstop;
	...
	dt = 3.23;
	i_recognize( dt, three23 );
	
	onefailed = 0;
	
	printf("Welcome to Section A.4.7.2.  \n");
	...
	for( n=1; n < 3; n++ ) { 
		...
		if( n==1 ) {
			i_recognize( -0.128, tetdiff );
		} else {
			i_recognize( -0.36925, tetdiff );
		...
		*/
		...
		for( subcase=casestart; subcase<=casebound; subcase++ ) {
			...
			for( a_case[1]=0; a_case[1]<1; a_case[1]++ ) {
				if( a_case[1]==0 ) {
					a_vect[2] = 2.0;
					a_vect[3] = 2.0;
				} else {
				...
				for( a_case[3]=0; a_case[3]<1; a_case[3]++ ) {
					if( a_case[3]==0 ) {
						a_vect[6] = 2.0;
						a_vect[7] = 2.0;
					} else {
					...
					for( a_case[4]=0; a_case[4]<1; a_case[4]++ ) {
						if( a_case[4]==0 ) {
							a_vect[8] = 2.0;
							a_vect[9] = 2.0;
						} else {
