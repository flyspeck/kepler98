...
void verifyocta( void )
{
	...
	printf("Welcome to Section A.4.4.2.3.  \n");
...
List(0.01617477123091815,-0.02241024550130943,
   -0.02241024550130943,0.02241024550130943,
   -0.01617477123091815,0.02241024550130943,
   0.02241024550130943,-0.02241024550130943,
   0.01617477123091815,-0.01617477123091815,
   0.02241024550130943,0.02241024550130943,
   -0.02241024550130943,0.01617477123091815,
   -0.01617477123091815,0.01617477123091815,
   -0.02241024550130943,-0.02241024550130943,
   0.02241024550130943,-0.01617477123091815,
   0.2556698352724156,0.4100099022013394,
   0.5892918662117995,0.2556698352724156,
   0.783538852896537,0.3395859998455025)
...
*/
	int i, j, k;
	double full_pent[32], cutval, cutval2, temp[2];
	...
	/* y1 */
	i_recognize( 2.2, temp );
	full_pent[0] = temp[0];
	full_pent[1] = TWO51_HI;
	/* discard this case completely */
