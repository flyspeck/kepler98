...
void verifyocta( void )
{
	...
	printf("Welcome to Section A.4.4.1.  \n");
...
void set_relation( int num )
{
	int i, j;
	double bigmat[4][8] = 
		{{-0.35, 0.15, 0.15, -0.7022, 0.17, 0.0, 
				0.0123, 1.0},
		 {0.13,-0.631, -0.31, 0.58, -0.413, -0.025, 
		 		-2.63363, -1.0},
		 {-0.714, 0.221, 0.221, -0.92, 0.221, 0.221, 
		 		-0.3482, 1.0},
		 {0.315, -0.3972, -0.3972, 0.715, -0.3972, -0.3972, 
		 		-2.37095, -1.0}};
