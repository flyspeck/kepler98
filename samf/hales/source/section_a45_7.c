...
void verifyocta( void )
{
	...
	printf("Welcome to Section A.4.5.7.  \n");
	...
	for( n=1; n < 2; n++ ) { 
		...
		if( n==1 ) {
			i_recognize( -0.073, tetdiff );
		} else {
			i_recognize( -0.54525 + 0.0 + 0.31, tetdiff );
