...
void verifyocta( void )
{
	...
	printf("Welcome to Section A.4.6.1.b.  \n");
	...
	for( n=1; n < 3; n++ ) { 
		...
		if( n==1 ) {
			i_recognize( -0.212 - 0.0461, tetdiff );
		} else {
...
{
	int i, j, bounds[2], n0, n1;
	double diff[6], t[12], val;
	double xp[12], yp[12], ynew[4];
	double data[2];
