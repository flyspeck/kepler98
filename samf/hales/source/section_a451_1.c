...
void verifyocta( void )
{
	...
	printf("Welcome to Section A.4.5.1.1.  \n");
...
void set_relation( int num )
{
	int i, j;
	double bigmat[4][8] = 
		{{-0.636, 0.462, 0.462, -0.82, 0.462, 0.462, 
				1.82419, 1.0},
		 {0.55, -0.214, -0.214, 1.24, -0.214, -0.214, 
		 		0.75281, -1.0},
		 {-0.15, 0.4, 0.09, -0.57, 0.631, 0.23, 
		 		2.5481, 1.0},
		 {0.34, -0.454, 0.154, 0.805, -0.346, 0.0, 
		 		-0.3429, -1.0}};
